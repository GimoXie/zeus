<#import "/include/zeus.ftl" as zeus/>
    ...
    <div id="wrapper">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        ...
                        <div class="logo-element">Zeus
                        </div>
                    </li>
                    <@zeus.generateMenu principal.menuList/>
                </ul>
            </div>
        </nav>
        <!--左侧导航结束-->
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
                    ...
                    <div class="navbar-header"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                        <form role="search" class="navbar-form-custom" method="post" action="#">
                            <div class="form-group">
                                <input type="text" placeholder="请输入您需要查找的内容 …(功能暂未开放)" class="form-control" name="top-search" id="top-search">
                            </div>
                        </form>
                    </div>
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="dashboard" frameborder="0" data-id="dashboard"></iframe>
            </div>
            <div class="footer">
                <div class="pull-right">&copy; 2017-2018 <a href="http://www.gimo.io/" target="_blank">gimo's blog</a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
